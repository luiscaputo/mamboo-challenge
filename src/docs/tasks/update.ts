export default {
  put: {
    tags: ['Tasks'],
    description: 'Object to send when u update a existent task',
    operationId: 'update',
    parameters: [
      {
        name: '_id',
        ...
        schema: {
          type: 'string',
          description: 'Id of the task for update',
          example: '63882ae5de050417f3612952',
        },
      },
      {
        name: 'title',
        ...
        schema: {
          type: 'string',
          description: 'Title for update task',
      ...
      },
      {
        ...
        schema: {
          type: 'string',
          description: 'Update Description this task',
